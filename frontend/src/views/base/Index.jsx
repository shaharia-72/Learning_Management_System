                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                                <div className="col">
                                    {/* Card with hover and 3D effect */}
                                    <div className="card card-hover h-100 border-0 shadow-sm hover-shadow-lg transition-all">
                                        <Link to={`/course-detail/slug/`} className="overflow-hidden rounded-top">
                                            <img
                                        ...
                                        <div className="card-body">
                                            <div className="d-flex justify-content-between align-items-center mb-3">
                                                <span className="badge bg-info bg-opacity-10 text-info">Intermediate</span>
                                                <a href="#" className="fs-5 text-muted hover-danger">
                                                    <i className="bi bi-heart"></i>
                                                </a>
                                            </div>
                                            <h4 className="mb-2 text-truncate-line-2">
                                                <Link to={`/course-detail/slug/`} className="text-inherit text-decoration-none text-dark fs-5 fw-bold">
                                            ...
                                            <div className="lh-1 mt-3 d-flex align-items-center">
                                                ...
                                                <span className="text-warning fw-bold me-1">4.5</span>
                                        ...
                                        <div className="card-footer bg-transparent border-top-0 pb-3">
                                            <div className="row align-items-center g-0">
                                                <div className="col">
                                                    <h5 className="mb-0 fw-bold">$39.00</h5>
                                                </div>
                                                <div className="col-auto">
                                                    <button type='button' className="btn btn-sm btn-outline-primary me-2 rounded-circle">
                                                        <i className="bi bi-cart"></i>
                                                    </button>
                                                    <Link to={""} className="btn btn-sm btn-primary rounded-pill">
                            ...
                            <nav className="d-flex mt-5 justify-content-center">
                                <ul className="pagination">
                                    <li className="page-item">
                                        <button className="page-link me-1 rounded-pill">
                                ...
                                <ul className="pagination mx-2">
                                    <li key={1} className="page-item active">
                                        <button className="page-link rounded-circle">
                                            1
                                        </button>
                                    </li>
                                ...
                                <ul className="pagination">
                                    <li className="page-item">
                                        <button className="page-link ms-1 rounded-pill">
                                            Next
