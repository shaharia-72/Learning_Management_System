              ...
              <div className="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                ...
                (
                  <div className="card h-100 border-0 shadow-sm rounded-4 overflow-hidden position-relative">
                    <Link to={`/course/course-detail/${c.slug}`} className="d-block overflow-hidden">
                      <img
                        src={c.image}
                        alt={c.title}
                    ...
                    <div className="card-body d-flex flex-column">
                      ...
                      <div className="mb-2 small text-muted">
                        <strong>By:</strong> {c.teacher.full_name}<br />
                        <strong>Students:</strong> {c.students?.length} Student{c.students?.length > 1 ? "s" : ""}
                      </div>
                      ...
                      <div className="d-flex align-items-center mb-3">
                        <div className="d-inline-flex align-items-center px-2 py-1 bg-light rounded-pill shadow-sm">
                          ...
                          <span className="text-muted small">({c.reviews?.length} Reviews)</span>
                        </div>
                      ...
                      <div className="mt-auto pt-2 border-top d-flex justify-content-between align-items-center">
                        <span className="fw-bold">BDT {c.price}</span>
                        <div>
                          <button className="btn btn-sm btn-outline-primary rounded-circle me-2">
                            <i className="bi bi-cart"></i>
                          </button>
                          <Link to={`/course-detail/${c.slug}`} className="btn btn-sm btn-primary rounded-pill">
